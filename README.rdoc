...
type boilerplate code to get started on a project. dm-gen uses templater
(http://github.com/jnicklas/templater) as a base.

Currently it supports only one generator, the 'one file' generator.
